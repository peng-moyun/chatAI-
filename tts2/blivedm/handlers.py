...
class BaseHandler(HandlerInterface):
    ...
    """
    # print(HandlerInterface)

    def __interact_word_callback(self, client: client_.BLiveClient, command: dict):
        # print(command)
        return self._on_welcome_name(client, models.INTERACTION.from_command(command['data']))
    ...
    async def _on_welcome_name(self, client: client_.BLiveClient, message: models.INTERACTION):
        """
        用户进场
        """
